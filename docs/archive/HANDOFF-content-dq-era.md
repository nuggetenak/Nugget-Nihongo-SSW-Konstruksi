# HANDOFF.md — content-dq era (archived 2026-08-19)

Retired out of the live `HANDOFF.md` during a documentation cleanup at the start of the
`feat/ui-overhaul` phase. Nothing here is live instruction — it's kept for background on how
content-dq's 29-session relay actually worked, and the full narrative of the 2026-08-18 merge.

For the condensed, current version of this record:
- **What shipped in the merge:** `CHANGELOG.md` `[4.23.0]`
- **Session-by-session log, all 29 sessions:** `_MAP.md` § Agent Session Log
- **Card data schema/taxonomy that came out of it:** `docs/CARD_CONTENT_SPEC.md`

Two things follow: (1) the original GETTING STARTED + PROTOCOL sections, which governed the
content-dq relay workflow itself, and (2) the full 2026-08-18 merge-execution entry that used
to sit at the top of `HANDOFF.md`'s CURRENT STATE section.
...
## Full 2026-08-18 merge-execution CURRENT STATE entry (as it read at the time)
...
## Full ACTIVE TASKS + OPEN DECISIONS sections (as they read at the time, archived 2026-08-19)
...
## Content-dq-specific RULES entries (archived 2026-08-19)

The general rules ("never push to main", "don't guess on ambiguity", "check git log for the
active commit convention") stayed live in HANDOFF.md. These were specific to content-dq's
`src/data/` editing work and archived with everything else:
