...
| `SSW_UPGRADE_PROPOSAL_v1.md` | Audit/Proposal | Full audit of all 15 modes (v3 of doc, hygiene passes ×3). 71 findings, 11 bugs — all resolved by v4.14.0. **NO OPEN ITEMS.** | `docs/BLUEPRINT-CURRENT.md` |
...
| `CONTENT-BLUEPRINT.md` | Content Proposal | Crunchy's audit of the content layer: track mismatch, lifeline dominance, JAC PDF gap. | `docs/BLUEPRINT-CURRENT.md` §Open Items |
...
*Last updated: 2026-08-18 — content-dq/main merge, archives combined.*
