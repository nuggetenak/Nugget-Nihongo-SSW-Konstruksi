# SSW Konstruksi — Data Quality Handoff v8

**Updated by:** Data Quality Agent (May 2026)
**Supersedes:** v1–v7 (this is the canonical single-source handoff)
**Scope:** ALL content files — cards + soal + pairs + angka
**Repo:** https://github.com/nuggetenak/Nugget-Nihongo-SSW-Konstruksi/
**Last commit:** `007e686` — P2+P4+P8+P9+P10+storage-v5 completed and pushed
...
| ------------------- | --------- | ------------- | --------------------- | ---------- | ---------------- |
| `cards-common.js`   | 879       | ~142          | ~84                   | ~553       | ~100             |
| `cards-lifeline.js` | 564       | ~83           | ~35                   | ~358       | ~88              |
| **TOTAL**           | **1,443** | **~225**      | **~119**              | **~911**   | **~188**         |
...
| **P5**   | Add 《》 ruby to bare kanji jp                   | source                                 | **~1085 cards remaining**                           | OPEN       |
...
**Next agent should start at P5 (bare kanji ruby, ~1085 cards — biggest task). Suggest batching by category or source.**
