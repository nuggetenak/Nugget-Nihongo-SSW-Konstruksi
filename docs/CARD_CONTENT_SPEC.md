...
_Diverifikasi 2026-05-14 dari actual files di content-dq. Zero edits saat audit._
...
_(Session 25 due-diligence note: this reflects the state at the time this spec was first
...
breakdown below — that's the pre-DQ-campaign baseline, not current.)_
...
_(Less critical karena furi deprecated, tapi jp field tetap perlu diverifikasi)_
...
**Konsep:** Menjawab _bagaimana_, _mengapa_, _cara kerja_, _apa bedanya X vs Y_. Bukan hanya "X adalah Y."

**Vocab:** Kalimat 1 = definisi inti. Kalimat 2 opsional via `\n` = konteks lapangan atau contrast dengan term lain.

**Hukum:** Wajib ada threshold, angka, atau kewajiban konkret. Menjawab: _berapa / kapan / siapa wajib_.
...
>
> - `src/tests/data.test.js:34` — test bernama _"every card has furi field (Phase 1)"_, assert
...
> jumlah soal merata, kualitas soal & opsi jawabannya juga ditingkatkan."_ P8a/P8b/P10/P11 memang
