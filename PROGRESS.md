...
**Branch:** content-dq
**Last updated:** 2026-05-10 (cp03 done)
...
- [ ] `src/data/sets/csv/cp05.js` — FIX + ANNOTATE opts
- [ ] `src/data/sets/csv/cp06.js` — FIX + ANNOTATE opts
- [ ] `src/data/sets/csv/ct01.js` — FIX + ANNOTATE opts
...
- [ ] `src/data/sets/csv/ct06.js` — FIX + ANNOTATE opts
...
- [ ] `src/data/sets/quiz/kenchiku-02.js` — RUBY+HINT+ID
- [ ] `src/data/sets/quiz/kenchiku-03.js` — RUBY+HINT+ID
