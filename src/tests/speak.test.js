...
describe('Phase F — speak.js', () => {
  ...
  it('HVPT cycling: each call uses different rate params', () => {
    ...
    Object.defineProperty(globalThis.SpeechSynthesisUtterance.prototype, 'rate', {
      writable: true,
      value: 1,
    });
    Object.defineProperty(globalThis.SpeechSynthesisUtterance.prototype, 'pitch', {
      writable: true,
      value: 1,
    });
    Object.defineProperty(globalThis.SpeechSynthesisUtterance.prototype, 'lang', {
      writable: true,
      value: '',
    });
