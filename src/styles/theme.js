...
export const T = {
  ...
  correct: '#16a34a',
  correctBg: 'rgba(22,163,74,0.10)',
  correctBorder: 'rgba(22,163,74,0.35)',
  wrong: '#dc2626',
  wrongBg: 'rgba(220,38,38,0.10)',
  wrongBorder: 'rgba(220,38,38,0.35)',
  track: {
    doboku:   { color: '#D97706', bg: 'rgba(217,119,6,0.10)',  icon: '🏗️', label: 'Teknik Sipil',       jp: '土木' },
    kenchiku: { color: '#0284C7', bg: 'rgba(2,132,199,0.10)', icon: '🏢', label: 'Bangunan',            jp: '建築' },
    lifeline: { color: '#059669', bg: 'rgba(5,150,105,0.10)', icon: '⚡', label: 'Lifeline & Peralatan', jp: 'ライフライン・設備' },
  },
  shadow: {
    sm:        'var(--ssw-shadowSm)',
    md:        'var(--ssw-shadowMd)',
