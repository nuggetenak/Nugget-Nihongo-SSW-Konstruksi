...
export const THEMES = {
  light: {
    ...
    '--ssw-textMuted': 'rgba(28,25,23,0.72)',
    '--ssw-textDim': 'rgba(28,25,23,0.60)',
    '--ssw-textFaint': 'rgba(28,25,23,0.45)',
  ...
  dark: {
    ...
    '--ssw-textMuted': 'rgba(254,243,199,0.72)',
    '--ssw-textDim': 'rgba(254,243,199,0.58)',
    '--ssw-textFaint': 'rgba(254,243,199,0.42)',
