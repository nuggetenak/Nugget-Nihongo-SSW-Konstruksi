  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: 14, color: T.textMuted, fontWeight: 600, marginBottom: 12 }}>
          {grade.label}
        </div>
        ...
        <>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            {review.map((r, i) => (
              ...
              >
                <div
                  style={{ fontSize: 13, fontFamily: T.fontJP, marginBottom: 5, lineHeight: 1.5 }}
                >
                  {r.question}
                </div>
                ...
                {r.explanation && (
                  ...
                  >
                    💡 {r.explanation.slice(0, 150)}
                    {r.explanation.length > 150 ? '…' : ''}
                  </div>
                )}
              </div>
            ))}
