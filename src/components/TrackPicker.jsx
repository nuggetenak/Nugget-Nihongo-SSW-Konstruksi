  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: "center", marginBottom: 28 }}>
        <div style={{ fontSize: 13, color: T.textDim, letterSpacing: 1.5, textTransform: "uppercase", marginBottom: 6 }}>
          Pilih Jalur Belajar
        </div>
        <div style={{ fontSize: 20, fontWeight: 800 }}>
          <span style={{ background: T.accent, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Bidang Apa Yang Kamu Pelajari?</span>
        </div>
      </div>
        ...
        {TRACKS.map((track, i) => {
          ...
          return (
            <button
              ...
              style={{
                fontFamily: "inherit", padding: "18px 16px",
                borderRadius: T.r.xl, cursor: "pointer",
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: 15, fontWeight: 700, marginBottom: 2 }}>{track.label}</div>
                  <div style={{ fontSize: 12, fontFamily: T.fontJP, color: active ? "rgba(255,255,255,0.7)" : T.textMuted, marginBottom: 3 }}>{track.jp}</div>
                  <div style={{ fontSize: 11, color: active ? "rgba(255,255,255,0.55)" : T.textDim, lineHeight: 1.3 }}>{track.desc}</div>
                </div>
                {active && (
      ...
      {/* Info */}
      <div style={{ fontSize: 11, color: T.textFaint, textAlign: "center", marginBottom: 20, lineHeight: 1.5 }}>
        Materi umum (keselamatan, hukum, KY, 5S) otomatis termasuk di semua jalur.<br />
      ...
      <button
        ...
        style={{
          ...
          fontFamily: "inherit", borderRadius: T.r.md, border: "none", cursor: selected ? "pointer" : "default",
