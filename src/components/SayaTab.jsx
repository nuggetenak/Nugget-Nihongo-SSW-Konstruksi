    ...
    <div className={s.container}>
      ...
      <Section title="Info">
        ...
        <Row
          ...
          sub={`${total} kartu · 3 jalur · FSRS SRS · SSW Konstruksi v4.3.1`}
          onClick={() => toast.show(`SSW Konstruksi v4.3.1 · ${total} kartu · FSRS · by Nugget Nihongo 🏗️`)}
        />
      </Section>

      <div className={s.footer}>
        SSW Konstruksi v4.3.1<br />
