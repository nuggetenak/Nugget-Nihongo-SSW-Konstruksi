...
export default function Dashboard({ known, unknown, track, onNavigate, onChangeTrack }) {
  ...
  // Suggested next action based on progress
  const getSuggestion = () => {
    ...
    return { icon: "🎯", label: "Simulasi Ujian", desc: "Kamu sudah siap latihan ujian!", mode: "simulasi" };
  };
    ...
    <div style={{ padding: "0 16px 24px", maxWidth: T.maxW, margin: "0 auto", animation: "fadeIn 0.3s ease" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          borderRadius: "50%", background: `radial-gradient(circle, ${T.amber}12, transparent 70%)`,
        }} />
      ...
      {/* Stats Row */}
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 14, animation: "slideUp 0.4s ease 0.15s both" }}>
        {[
          ...
          <div key={i} style={{
            padding: "12px 8px", borderRadius: T.r.md,
      ...
      {/* Footer */}
      <div style={{ textAlign: "center", marginTop: 28, fontSize: 10, color: T.textFaint, animation: "fadeIn 0.5s ease 0.3s both" }}>
