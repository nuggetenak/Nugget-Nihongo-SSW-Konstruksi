...
// Uses KENCHIKU_SETS data, saves scores to kenchikuScores in storage v3.
// ─────────────────────────────────────────────────────────────────────────────
...
export default function KenchikuMode({ onExit, onSessionEnd }) {
  const KENCHIKU_SETS = getQuizSetsForTrack('kenchiku');
  const [selectedSet, setSelectedSet] = useState(null);
  const scores = get('progress')?.kenchikuScores ?? {};
