  ...
  return (
    <div style={{ padding: '24px 16px', maxWidth: T.maxW, margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: 11, color: T.textDim, marginTop: 2 }}>
              Soal SSW Konstruksi jalur 建築 sedang disiapkan. Upload PDF sumber ke sesi berikutnya untuk mulai build.
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ marginBottom: 8 }}>
        <div style={{ fontSize: 11, fontWeight: 800, color: T.textMuted, letterSpacing: 1.5, textTransform: 'uppercase', marginBottom: 12 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {PLANNED_CONTENT.map((item) => (
            ...
            >
              ...
              <span style={{ fontSize: 9, fontWeight: 700, color: T.textDim, background: T.border, borderRadius: T.r.pill, padding: '2px 7px', flexShrink: 0 }}>
                SOON
              </span>
            </div>
          ))}
