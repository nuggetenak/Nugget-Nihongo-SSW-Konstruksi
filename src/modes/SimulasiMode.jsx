      ...
      <div style={{ padding: '24px 16px', maxWidth: T.maxW, margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 13, color: T.textMuted }}>
            Format ujian SSW Konstruksi dengan timer
          </p>
        </div>
        ...
        >
          {INSTRUCTIONS.map((inst, i) => (
            <div key={i} style={{ fontSize: 12, color: T.textMuted, lineHeight: 1.9 }}>
              {inst}
            </div>
          ))}
        </div>
            ...
            >
              ...
              <div>
                ...
                <div
                  style={{
                    fontSize: 11,
                    color: preset === p.key ? 'rgba(239,68,68,0.7)' : T.textDim,
                    marginTop: 2,
                  }}
                >
                  {p.sub}
              ...
              {wrongList.map((r, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      style={{ fontSize: 11, color: T.textDim, marginBottom: 8, lineHeight: 1.4 }}
                    >
                      {r.id_text}
                    </div>
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          >
            <div style={{ color: T.correct, fontWeight: 700 }}>
