  ...
  if (!started) {
    return (
      <div style={{ padding: "24px 16px", maxWidth: T.maxW, margin: "0 auto" }}>
        ...
        <p style={{ fontSize: 13, color: T.textMuted, marginBottom: 12 }}>{ANGKA_KUNCI.length} angka penting yang WAJIB dihafal untuk ujian.</p>
        ...
        <div style={{ marginBottom: 20 }}>
          {ANGKA_KUNCI.map((a, i) => (
            <div key={i} style={{
              ...
              <span style={{ color: T.gold, fontWeight: 700, minWidth: 60, textAlign: "right" }}>{a.value}</span>
            </div>
          ))}
        </div>
