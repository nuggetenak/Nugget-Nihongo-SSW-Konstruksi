...
export const CATEGORIES = [
  ...
  { key: "salam",          label: "挨拶・安全",     color: "#c05621", emoji: "🙏", tracks: ["doboku","kenchiku","lifeline"] },
  { key: "hukum",          label: "法律・規制",     color: "#285e61", emoji: "⚖️", tracks: ["doboku","kenchiku","lifeline"] },
  { key: "jenis_kerja",    label: "工事の種類",     color: "#1a365d", emoji: "🏗️", tracks: ["doboku","kenchiku"] },
  ...
  { key: "keselamatan",    label: "安全管理",       color: "#22543d", emoji: "🦺", tracks: ["doboku","kenchiku","lifeline"] },
  { key: "karier",         label: "キャリア・雇用", color: "#553c9a", emoji: "👷", tracks: ["doboku","kenchiku","lifeline"] },
  { key: "alat_umum",      label: "共通工具",       color: "#2d3748", emoji: "🔨", tracks: ["doboku","kenchiku"] },
...
export const SOURCE_META = {
  ...
  "vocab-exam":   { label: "Vocab Exam — 250 kosakata ujian Prometric", emoji: "🎯", color: "#7c3aed" },
  "vocab-teori":  { label: "Vocab Teori — Kosakata 学科 (hukum & safety)", emoji: "📋", color: "#dc2626" },
};
