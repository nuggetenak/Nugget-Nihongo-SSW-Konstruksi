// wt03.js — Wayground Set: wt03 (P22 session 28: hand-authored 4th option + rebalance)
export const SET_WT03 = {
  id: 'wt03',
  title: 'Teori Set 3 · 20qs',
  subtitle: '労働基準法・雇用・36協定',
  emoji: '⚖️',
  color: '#eab308',
  grad: 'linear-gradient(135deg,#713f12,#ca8a04)',
  ...
  questions: [
    {
      ...
      opts: ['40 時間《じかん》', '48 時間《じかん》', '36 時間《じかん》', '44 時間《じかん》'],
      opts_id: ['40 jam', '48 jam', '36 jam', '44 jam'],
      ans: 0,
    ...
    {
      id: 2,
      q: '法定労働時間《ほうていろうどうじかん》では、働く時間《じかん》は 1 日何時間《なんじかん》までか。',
      hint: 'Menurut waktu kerja resmi, berapa jam maksimal kerja per hari?',
      opts: ['10 時間《じかん》', '8 時間《じかん》', '6 時間《じかん》', '9 時間《じかん》'],
      opts_id: ['10 jam', '8 jam', '6 jam', '9 jam'],
      ans: 1,
    ...
    {
      id: 4,
      q: '労働基準法《ろうどうきじゅんほう》で、深夜労働《しんやろうどう》（22時《とき》～5時《とき》）の割増賃金《わりましちんぎん》率《りつ》は？',
      hint: 'Tarif upah tambahan untuk kerja malam (22.00–05.00) menurut UU Standar Ketenagakerjaan adalah?',
      opts: ['2.0 倍《ばい》', '1.35 倍《ばい》', '1.0 倍《ばい》', '1.25 倍《ばい》'],
      opts_id: ['2.0 kali', '1,35 kali', '1.0 kali', '1.25 kali'],
      ans: 3,
    ...
    },
    {
      ...
      opts_id: ['720 jam/tahun', '45 jam/bulan', 'Bebas', '60 jam/bulan'],
      ans: 0,
    ...
    {
      id: 7,
      q: '労働基準法《ろうどうきじゅんほう》で、週《しゅう》1回《かい》の休日《きゅうじつ》（法定《ほうてい》休日《きゅうじつ》）の最低基準《さいていきじゅん》は？',
      hint: 'Menurut UU Standar Ketenagakerjaan, berapa hari libur mingguan minimal (libur resmi)?',
      opts: ['任意《にんい》', '2 日《ひ》', '1 日《ひ》', '半日《はんにち》'],
      opts_id: ['Bebas', '2 hari', '1 hari', 'Setengah hari'],
      ans: 2,
    ...
    {
      id: 8,
      q: '労働基準法《ろうどうきじゅんほう》で、年次有給休暇《ゆうきゅうきゅうか》の最低《さいてい》付与《ふよ》日数《にっすう》は？',
      hint: 'Jumlah minimal hari cuti tahunan yang diberikan menurut UU Standar Ketenagakerjaan adalah?',
      opts: ['15 日《ひ》', '20 日《にち》', '5 日《ひ》', '10 日《ひ》'],
      opts_id: ['15 hari', '20 hari', '5 hari', '10 hari'],
      ans: 3,
    ...
    {
      id: 9,
      q: '有給休暇《ゆうきゅうきゅうか》の取得《しゅとく》義務《ぎむ》は、雇用《こよう》から何年目以降か。',
      hint: 'Kewajiban mengambil cuti tahunan berlaku mulai tahun ke berapa?',
      opts: ['2 年目以降', '5 年目以降', '1 年目', '半年《はんとし》後《ご》'],
      opts_id: [
    ...
    {
      id: 11,
      q: '有給休暇《ゆうきゅうきゅうか》の取得《しゅとく》率《りつ》を向上《こうじょう》させるために、事業主《じぎょうぬし》が講ず《こうず》べき措置《そち》として正しい《ただしい》ものは？',
      hint: 'Langkah yang benar bagi pengusaha untuk meningkatkan tingkat pengambilan cuti tahunan adalah?',
      opts: [
        '取得《しゅとく》を禁止《きんし》する',
        '取得《しゅとく》日数《にっすう》を減ら《へら》す',
        '計画的《けいかくてき》付与《ふよ》制度《せいど》を導入《どうにゅう》する',
        '給与《きゅうよ》から天引《てんび》きする',
      ],
      opts_id: [
    ...
    {
      id: 12,
      q: '日本《にっぽん》の「雇用《こよう》保険《ほけん》」について正しい《ただしい》ものはどれか。',
      hint: "Pernyataan yang benar tentang 'asuransi ketenagakerjaan' (雇用保険) di Jepang adalah?",
      opts: [
        '保険料《ほけんりょう》は労働者《ろうどうしゃ》のみが払う《はらう》',
        '全額《ぜんがく》事業主《じぎょうぬし》が負担《ふたん》する',
        'けがをした場合《ばあい》に医療費《いりょうひ》を補償《ほしょう》する',
        '解雇《かいこ》・倒産《とうさん》等《など》で失業《しつぎょう》した場合《ばあい》に給付《きゅうふ》を受け《うけ》られる',
      ],
      opts_id: [
    ...
    {
      id: 16,
      q: '労働安全衛生法《ろうどうあんぜんえいせいほう》で、事業主《じぎょうぬし》が実施《じっし》しなければならない健康《けんこう》診断の種類《しゅるい》は？',
    ...
    {
      id: 17,
      q: '労災保険《ろうさいほけん》の保険料《ほけんりょう》を支払《しはらい》うのは誰か。',
      ...
      opts_id: ['Kontraktor utama', 'Subkontraktor', 'Pekerja sendiri', 'Dibagi dengan pemerintah'],
      ans: 0,
    ...
    {
      id: 20,
      q: '人間《にんげん》の誤り《あやまり》（ヒューマンエラー）の主な《おもな》要因《よういん》の一つ《ひとつ》は？',
      ...
      opts_id: ['Kerja tim', 'Tidur cukup', 'Gaji yang tinggi', 'Kelelahan atau stres'],
      ans: 3,
