...
export const JAC_TEORI = [
  {
    ...
    opts: ['興味を持たないこと《きょうみをもたないこと》', 'チームワーク'],
  ...
  },
  {
    ...
    opts: ['6時間《6じかん》', '8時間《8じかん》', '12時間《12じかん》'],
  ...
  },
  {
    ...
    img: null,
    photoDesc:
      '📸 FOTO: Perangkat berbentuk silinder/bantalan karet tebal di bawah struktur bangunan — ini adalah 免振装置 (seismic isolator), sistem isolasi gempa yang memisahkan bangunan dari gerakan tanah.',
  ...
  },
  {
    ...
    img: null,
    photoDesc:
      '📸 FOTO: Beberapa pekerja berhelm merah & putih di atap bangunan mendatar, menggunakan selang besar & alat perata — ini adalah コンクリート打設工事 (pengecoran beton). Terlihat beton segar dituang & diratakan.',
  ...
  },
  {
    ...
    opts: ['KY活動《KYかつどう》', 'タッチアンドコール', 'ラジオ体操《ラジオたいそう》'],
  ...
  },
  {
    ...
    img: null,
    photoDesc:
      '📸 FOTO: Mesin paver aspal besar (asphalt finisher) berwarna hijau sedang bergerak di atas permukaan jalan, menghamparkan material aspal secara merata — ini adalah 敷き均し作業.',
  ...
  },
  {
    ...
    img: null,
    photoDesc:
      '📸 FOTO: Batang baja berulir (rebar) dengan coupling sleeve logam di tengah — ini adalah 機械式継手 (mechanical coupler/sambungan mekanis), tulangan disambung lewat selongsong berulir.',
