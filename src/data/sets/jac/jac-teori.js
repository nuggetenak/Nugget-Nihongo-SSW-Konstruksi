...
export const JAC_TEORI = [
  ...
  },
  {
    ...
    opts: [
      ...
      '不浄な水を供給する《ふじょうなみずをきょうきゅうする》'
    ],
    opts_id: [
      'Menyuplai air yang terjangkau',
      'Menyuplai air yang mahal',
  ...
  },
  {
    ...
    opts: [
      ...
      '既に使用された杭を再利用する工法《すでにしようされたくいをさいりようするこうほう》',
      '穴の中に生コンクリートを入れて杭を造る工法《あなのなかになまコンクリートをいれてくいをつくるこうほう》'
    ],
    opts_id: [
      'Tiang dibuat di pabrik, dibawa & dipancang di lapangan',
      'Tiang dibuat di lokasi proyek',
      'Tiang bekas digunakan kembali',
  ...
  },
  {
    ...
    opts_id: [
      'Teknisi pekerjaan listrik',
      'Penanggung jawab pekerjaan telekomunikasi',
      'Insinyur kepala telekomunikasi',
  ...
  },
  {
    ...
    opts: [
      ...
      'ごみが落《お》ちているのを見《み》つけたら、そのままにしておく',
      'ヘルメットや安全帯は決められた場所に置く《ヘルメットやあんぜんたいはきめられたばしょにおく》'
    ],
    opts_id: [
      'Merokok di tempat tersembunyi dari pandangan orang',
      'Biarkan sampah yang ditemukan',
  ...
  },
  {
    ...
    opts_id: [
      'Kegiatan KY/identifikasi bahaya',
      'Touch-and-call',
      'Senam radio'
    ],
    ans: 1,
  ...
  },
  {
    ...
    opts_id: [
      'Peningkatan KUALITAS SDM pelaku konstruksi',
  ...
  },
  {
    ...
    opts_id: [
      'Pekerjaan kabel',
      'Pekerjaan jalur pipa',
      'Pekerjaan panel distribusi listrik',
  ...
  },
  {
    ...
    opts: [
      'カーテン工事《カーテンこうじ》',
      '漆喰補修工事《しっくいほしゅうこうじ》',
      '吹付けウレタン断熱工事《ふきつけウレタンだんねつこうじ》'
    ],
    opts_id: [
      'Pemasangan tirai/curtain',
      'Perbaikan plester mortar',
  ...
  },
  {
    ...
    opts_id: [
      'Penyamaan ketinggian dengan air',
      'Setting-out/tata letak referensi',
  ...
  },
  {
    ...
    opts_id: [
      'Subgrade/lapisan sub-dasar jalan',
      'Pemadatan',
  ...
  },
  {
    ...
    opts_id: [
      'Pemakuan/menancapkan paku',
      'Mencabut dan menyimpan paku',
  ...
  },
  {
    ...
    opts: [
      ...
      '暑い時は半袖を着用する《あついときははんそでをちゃくようする》',
      '袖は手首までおろして着用する《そではてくびまでおろしてちゃくようする》'
    ],
    opts_id: [
      'Biarkan kancing jaket terbuka',
      'Saat panas, pakai baju lengan pendek',
