...
export const JAC_TEORI = [
  {
    ...
    opts: ['興味《きょうみ》を持《も》たないこと', 'チームワーク'],
    opts_id: ['Tidak peduli', 'Kerja tim / Teamwork'],
    ans: 1,
    img: null,
  ...
  },
  {
    ...
    setLabel: '学科 Set 1',
    topic: 'keselamatan',
    q: '一般的《いっぱんてき》には、朝礼《ちょうれい》の最後《さいご》に、２人《ふたり》１組《くみ》となって、声《こえ》を出《だ》しながら、（　）を行《おこな》う。',
    hint: 'Pada umumnya, di akhir apel pagi, berpasangan dua orang, sambil bersuara, melakukan ( ).',
    opts: ['あいさつ', '体操《たいそう》', '安全確認《あんぜんかくにん》'],
    opts_id: ['Salam', 'Senam', 'Konfirmasi keselamatan'],
    ans: 2,
    img: null,
  ...
  },
  {
    ...
    opts: ['パワー・ハラスメント', 'セクシャル・ハラスメント', 'アルコール・ハラスメント'],
    opts_id: ['Power Harassment', 'Sexual Harassment', 'Alcohol Harassment'],
    ans: 0,
    img: null,
  ...
  },
  {
    ...
    setLabel: '学科 Set 1',
    topic: 'hukum',
    q: '法定労働時間《ほうていろうどうじかん》では、働《はたら》く時間《じかん》は1日《にち》何時間《なんじかん》までか。',
    hint: 'Berdasarkan jam kerja yang ditetapkan undang-undang, batas jam kerja per hari adalah berapa jam?',
    opts: ['6時間《じかん》', '8時間《じかん》', '12時間《じかん》'],
    opts_id: ['6 jam', '8 jam', '12 jam'],
    ans: 1,
    img: null,
  ...
  },
  {
    ...
    opts_id: ['Yang menjamin keamanan', 'Minimum', 'Lebih dari yang diperlukan'],
    ans: 1,
    img: null,
  ...
  },
  {
    ...
    opts: ['増加《ぞうか》', '軽減《けいげん》'],
    opts_id: ['Meningkatkan', 'Mengurangi / Meringankan'],
    ans: 1,
    img: null,
  ...
  },
  {
    ...
    opts_id: ['Membangun rumah', 'Membangun jalan', 'Membangun bendungan'],
    ans: 0,
    img: null,
  ...
  },
  {
    ...
    opts_id: ['Alat kedap air', 'Alat isolasi seismik', 'Alat AC'],
    ans: 1,
    img: 'images/jac-official/tt1_q10.webp',
    photoDesc:
      'Bantalan tebal berlapis karet dan baja, dipasang di antara fondasi beton dan struktur bangunan di atasnya.',
  ...
  },
  {
    ...
    opts_id: ['Pekerjaan lifeline', 'Pekerjaan bangunan', 'Pekerjaan sipil'],
    ans: 0,
    img: null,
  ...
  },
  {
    ...
    opts_id: ['Pembesian', 'Sambungan tulangan', 'Bekisting/formwork', 'Pemasangan kusen jendela'],
    ans: 2,
    img: null,
  ...
  },
  {
    ...
    ans: 0,
    img: 'images/jac-official/tt1_q16.webp',
    photoDesc:
      'Beberapa pekerja berhelm di atas pelat lantai datar, memegang selang besar dan alat perata; permukaan basah sedang diratakan.',
  ...
  },
  {
    ...
    opts: ['洗面器《せんめんき》', '焼却炉《しょうきゃくろ》', 'スプリンクラー', 'エアコン'],
    opts_id: ['Wastafel', 'Incinerator/tungku pembakaran', 'Sprinkler', 'AC'],
    ans: 2,
    img: null,
  ...
  },
  {
    ...
    opts: ['作る《つくる》', '直す《なおす》', '組み立てる《くみたてる》', '壊す《こわす》'],
    opts_id: ['Membuat', 'Memperbaiki', 'Merakit', 'Menghancurkan/membongkar'],
    ans: 3,
    img: null,
  ...
  },
  {
    ...
    opts: ['免許《めんきょ》', 'パスポート', '在留カード《ざいりゅうカード》'],
    opts_id: ['Lisensi/izin resmi', 'Paspor', 'Kartu izin tinggal'],
    ans: 0,
    img: null,
  ...
  },
  {
    ...
    opts: ['海外《かいがい》', '社内《しゃない》', '労働局《ろうどうきょく》'],
    opts_id: ['Di luar negeri', 'Di dalam perusahaan', 'Di kantor tenaga kerja'],
    ans: 1,
    img: null,
  ...
  },
  {
    ...
    setLabel: '学科 Set 1',
    topic: 'keselamatan',
    q: '事故《じこ》やケガが無《な》く、無事《ぶじ》に１日《にち》の作業《さぎょう》が進《すす》められることを願《ねが》う気持《きも》ちを表《あらわ》すために、（　）というあいさつが使《つか》われる。',
    hint: 'Sapaan yang digunakan untuk mengungkapkan harapan agar pekerjaan sehari berjalan tanpa kecelakaan adalah ( ).',
    opts: ['お大事に《おだいじに》', 'ご安全《あんぜん》に', 'ご注意《ちゅうい》を'],
    opts_id: ['Jaga kesehatan ya', 'Semoga selamat', 'Harap berhati-hati'],
    ans: 1,
    img: null,
  ...
  },
  {
    ...
    opts: ['さようなら', 'どういたしまして', 'おつかれさまです'],
    opts_id: ['Selamat tinggal', 'Sama-sama', 'Terima kasih atas kerja kerasnya'],
    ans: 2,
    img: null,
  ...
  },
  {
    ...
    opts: ['立て墨《たてずみ》', '逃げ墨《にげずみ》', '仕上げ墨《しあげずみ》', '地墨《じずみ》'],
    opts_id: ['Garis vertikal', 'Garis referensi offset', 'Garis finishing', 'Garis lantai'],
    ans: 3,
    img: null,
  ...
  },
  {
    ...
    opts: ['根切り《ねぎり》', '盛り土《もりど》', '埋戻し《うめもどし》', '素掘り《すぼり》'],
    opts_id: [
      'Penggalian fondasi',
  ...
  },
  {
    ...
    opts: ['あき', 'あそび', 'かぶり厚さ《かぶりあつさ》', '間隔《かんかく》'],
    opts_id: [
  ...
  },
  {
    ...
    opts: ['空調《くうちょう》', '換気《かんき》', '排煙《はいえん》', '衛生《えいせい》'],
    opts_id: ['AC / pengkondisian udara', 'Ventilasi', 'Pembuangan asap', 'Sanitasi'],
    ans: 0,
    img: null,
  ...
  },
  {
    ...
    opts: ['修理《しゅうり》', '相談《そうだん》', 'しつけ'],
    opts_id: ['Perbaikan', 'Konsultasi', 'Disiplin/Shitsuke'],
    ans: 2,
    img: null,
  ...
  },
  {
    ...
    opts: ['朝礼《ちょうれい》', 'ラジオ体操《ラジオたいそう》', '安全唱和《あんぜんしょうわ》'],
    opts_id: ['Apel pagi', 'Senam radio', 'Nyanyian keselamatan'],
    ans: 0,
    img: null,
  ...
  },
  {
    ...
    opts: ['KY活動《かつどう》', 'タッチアンドコール', 'ラジオ体操《ラジオたいそう》'],
    opts_id: ['Kegiatan KY/identifikasi bahaya', 'Touch-and-call', 'Senam radio'],
    ans: 1,
    img: 'images/jac-official/tt2_q02.webp',
    photoDesc:
      'Sekelompok pekerja berhelm berdiri melingkar, menumpuk tangan mereka di tengah lingkaran.',
    exp: 'タッチアンドコール = semua anggota tumpuk tangan → teriak bersama → konfirmasi komitmen keselamatan. Berbeda dari KY活動《かつどう》 (identifikasi bahaya per titik).',
  ...
  },
  {
    ...
    opts: ['事業主《じぎょうぬし》', '労働者《ろうどうしゃ》'],
    opts_id: ['Pengusaha/pemberi kerja', 'Pekerja/karyawan'],
    ans: 0,
    img: null,
  ...
  },
  {
    ...
    opts: ['雇用保険法《こようほけんほう》', '労働安全衛生法《ろうどうあんぜんえいせいほう》'],
    opts_id: ['UU Asuransi Ketenagakerjaan', 'UU Keselamatan & Kesehatan Kerja'],
    ans: 1,
    img: null,
  ...
  },
  {
    ...
    opts: ['大気汚染物質《たいきおせんぶっしつ》', '廃材《はいざい》'],
    opts_id: ['Polutan udara', 'Material sisa/limbah konstruksi'],
    ans: 1,
    img: null,
  ...
  },
  {
    ...
    opts: ['都市《とし》', 'LP'],
    opts_id: ['Gas kota/city gas', 'Gas LPG'],
    ans: 0,
    img: null,
  ...
  },
  {
    ...
    opts: ['電気工事士《でんきこうじし》', '工事担任者《こうじたんにんしゃ》'],
    opts_id: ['Teknisi pekerjaan listrik', 'Penanggung jawab pekerjaan telekomunikasi'],
    ans: 1,
    img: null,
  ...
  },
  {
    ...
    opts: ['火災や感電《かさいやかんでん》', 'ガス漏れ《ガスもれ》'],
    opts_id: ['Kebakaran dan sengatan listrik', 'Kebocoran gas'],
    ans: 0,
    img: null,
  ...
  },
  {
    ...
    opts: ['治水《ちすい》', '汚水《おすい》', '排水《はいすい》', '治山《ちざん》'],
    opts_id: [
      'Pengendalian banjir',
      'Air kotor/limbah',
  ...
  },
  {
    ...
    opts: ['海路《かいろ》', '鉄道《てつどう》', '空路《くうろ》', '橋《はし》'],
    opts_id: ['Jalur laut', 'Jalur kereta api', 'Jalur udara', 'Jembatan'],
    ans: 1,
    img: null,
  ...
  },
  {
    ...
    opts: ['仮設《かせつ》', '排水《はいすい》', '山留め《やまどめ》', '試掘《しくつ》'],
    opts_id: ['Instalasi sementara', 'Drainase', 'Penahan tanah galian', 'Galian uji coba'],
    ans: 2,
    img: null,
  ...
  },
  {
    ...
    opts: ['内装仕上げ《ないそうしあげ》', '建具《たてぐ》', '屋根《やね》', '躯体《くたい》'],
    opts_id: ['Finishing interior', 'Kusen pintu/jendela', 'Atap', 'Struktur utama/kutai'],
    ans: 3,
    img: null,
  ...
  },
  {
    ...
    opts: ['ジャッキ', 'クレーン', '押輪《おしわ》'],
    opts_id: ['Dongkrak hidrolik/jack', 'Crane', 'Cincin pendorong'],
    ans: 0,
    img: null,
  ...
  },
  {
    ...
    opts_id: ['Pelatihan manajemen', 'Pelatihan keterampilan', 'Pelatihan teknisi inti'],
    ans: 1,
    img: null,
  ...
  },
  {
    ...
    ans: 2,
    img: 'images/jac-official/tt2_q18.webp',
    photoDesc:
      'Mesin beroda rantai berwarna hijau bergerak maju di atas jalan, meninggalkan lapisan aspal rata di belakangnya.',
  ...
  },
  {
    ...
    opts: ['押土《おしど》', '運搬《うんぱん》', '掘削《くっさく》'],
    opts_id: ['Mendorong tanah', 'Pengangkutan', 'Penggalian'],
    ans: 0,
    img: null,
  ...
  },
  {
    ...
    opts_id: ['Pemasangan tirai/curtain', 'Perbaikan plester mortar', 'Semprot insulasi uretan'],
    ans: 1,
    img: null,
  ...
  },
  {
    ...
    opts: ['打設《だせつ》', '保温《ほおん》', '支保工《しほこう》'],
    opts_id: ['Pengecoran', 'Isolasi termal', 'Perancah penyangga/shoring'],
    ans: 2,
    img: null,
  ...
  },
  {
    ...
    opts_id: ['Sambungan mekanis/coupler', 'Sambungan tumpang', 'Sambungan las'],
    ans: 0,
    img: 'images/jac-official/tt2_q22.webp',
    photoDesc:
      'Dua batang baja tulangan bersambung lewat selongsong logam berulir di bagian tengah.',
  ...
  },
  {
    ...
    opts_id: ['Las listrik', 'Gas pressure welding', 'Tumpang'],
    ans: 1,
    img: null,
  ...
  },
  {
    ...
    opts: ['配線工事《はいせんこうじ》', '接地工事《せっちこうじ》', '内線工事《ないせんこうじ》'],
    opts_id: ['Pekerjaan pengkabelan', 'Pekerjaan pentanahan', 'Pekerjaan instalasi dalam gedung'],
    ans: 2,
    img: null,
  ...
  },
  {
    ...
    opts: ['無線方式《むせんほうしき》', '光ファイバー《ひかりファイバー》', 'インターネット'],
    opts_id: ['Sistem nirkabel', 'Serat optik', 'Internet'],
    ans: 0,
    img: null,
  ...
  },
  {
    ...
    opts: ['エアコン', 'トイレの便器《トイレのべんき》', '貯湯槽《ちょとうそう》'],
    opts_id: ['AC', 'Closet/toilet', 'Tangki air panas'],
    ans: 1,
    img: null,
  ...
  },
  {
    ...
    opts: ['消火設備《しょうかせつび》', '避難設備《ひなんせつび》', '警報設備《けいほうせつび》'],
    opts_id: ['Peralatan pemadam kebakaran', 'Peralatan evakuasi', 'Peralatan alarm/peringatan'],
    ans: 2,
    img: null,
  ...
  },
  {
    ...
    opts_id: ['Bahaya! / Awas!', 'Kondisi kaki/pijakan aman', 'Semoga selamat', 'Berdiri'],
    ans: 0,
    img: null,
  ...
  },
  {
    ...
    opts: ['水盛り《みずもり》', '遣り方《やりかた》', '水貫《みずぬき》'],
    opts_id: [
  ...
  },
  {
    ...
    opts: ['路床《ろしょう》', '締固め《しめかため》', '段切り《だんぎり》'],
    opts_id: ['Subgrade/lapisan sub-dasar jalan', 'Pemadatan', 'Potongan bertangga/step cutting'],
    ans: 2,
    img: null,
  ...
  },
  {
    ...
    opts: ['坪《つぼ》', '寸《すん》', '尺《しゃく》'],
    opts_id: ['Tsubo — satuan luas tradisional', 'Sun — satuan panjang', 'Shaku — satuan panjang'],
    ans: 0,
    img: null,
  ...
  },
  {
    ...
    opts: ['打ち込み《うちこみ》', '釘仕舞《くぎじまい》', '釘止め《くぎどめ》'],
    opts_id: ['Pemakuan/menancapkan paku', 'Mencabut dan menyimpan paku', 'Pengikatan dengan paku'],
    ans: 1,
    img: null,
  ...
  },
  {
    ...
    opts: ['接続《せつぞく》', '配線《はいせん》', '絶縁《ぜつえん》'],
    opts_id: ['Penyambungan', 'Pengkabelan', 'Isolasi'],
    ans: 2,
    img: null,
  ...
  },
  {
    ...
    opts: ['接地《せっち》', '漏電《ろうでん》', '通線《つうせん》'],
    opts_id: ['Pentanahan/grounding', 'Kebocoran arus', 'Penarikan kabel'],
    ans: 0,
    img: null,
  ...
  },
  {
    ...
    opts: ['掃除《そうじ》', '整頓《せいとん》', '清潔《せいけつ》'],
    opts_id: ['Membersihkan', 'Menata/merapikan — Seiton', 'Bersih/higienis — Seiketsu'],
    ans: 1,
    img: null,
