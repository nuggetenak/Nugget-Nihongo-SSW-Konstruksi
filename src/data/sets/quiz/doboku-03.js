    ...
    questions: [
      {
        ...
        ans: 0,
        exp: 'Menurut peraturan K3 Jepang, tempat dengan kadar oksigen di bawah 18% = lingkungan defisiensi oksigen (酸素欠乏《さんそけつぼう》). Udara normal = 21%. Kesalahan umum: menjawab 21% (itu kadar normal).',
        cat: 'hourei',
      ...
      },
      {
        ...
        ans: 0,
        exp: '労働安全衛生法《ろうどうあんぜんえいせいほう》 (UU K3 Jepang) mewajibkan pemberi kerja menjamin keselamatan dan kesehatan pekerja. Ini bukan soal profit atau jadwal.',
        cat: 'hourei',
      ...
      },
      {
        ...
        hint: 'Di proyek mana petugas K3 (安全衛生責任者《あんぜんえいせいせきにんしゃ》) wajib ditunjuk?',
        ...
        ans: 0,
        exp: 'Petugas K3 (安全衛生責任者《あんぜんえいせいせきにんしゃ》) wajib ditunjuk saat proyek melibatkan kontraktor utama (元請《もとうけ》) dan subkontraktor (下請《したうけ》) bekerja bersama — untuk koordinasi keselamatan antar perusahaan.',
        cat: 'hourei',
      ...
      },
      {
        ...
        hint: 'Pekerjaan mana yang memerlukan supervisor bersertifikat (作業主任者《さぎょうしゅにんしゃ》)?',
        ...
        ans: 0,
        exp: 'Pekerjaan berisiko tinggi seperti pemasangan shoring bekisting (型枠支保工《かたわくしほこう》) wajib ada 作業主任者《さぎょうしゅにんしゃ》 (supervisor kerja bersertifikat). Kebersihan dan pengangkutan biasa tidak memerlukan.',
        cat: 'hourei',
      ...
      },
      {
        ...
        ans: 0,
        exp: 'Pelarut organik (有機溶剤《ゆうきようざい》) = beracun. WAJIB pakai masker anti gas (防毒《ぼうどく》マスク) DAN pastikan ventilasi (換気《かんき》). Sarung tangan kain saja tidak cukup melindungi dari uap kimia.',
        cat: 'anzen',
      ...
      },
      {
        ...
        ans: 0,
        exp: 'Asbes (石綿《いしわた》/アスベスト) = karsinogenik. Pembongkaran material ber-asbes WAJIB: (1) survei awal, (2) melapor ke pemerintah, (3) tindakan pencegahan penyebaran serat. Bukan pekerjaan biasa.',
        cat: 'hourei',
      ...
      },
      {
        ...
        ans: 0,
        exp: 'Untuk mencegah kesetrum (感電《かんでん》), pastikan alat listrik terhubung grounding/arde (アース/接地《せっち》) dengan benar. Warna, usia, atau harga alat tidak relevan dengan keselamatan listrik.',
        cat: 'anzen',
      ...
      },
      {
        ...
        ans: 0,
        exp: '新規入場者教育《しんきにゅうじょうしゃきょういく》 = orientasi keselamatan untuk pekerja yang PERTAMA KALI masuk proyek tersebut. Bukan bulanan atau tahunan.',
        cat: 'hourei',
      ...
      },
      {
        ...
        ans: 0,
        exp: 'Pemasangan scaffolding ≥5m WAJIB ada supervisor bersertifikat (足場《あしば》の組立て等作業主任者《くみたてとうさぎょうしゅにんしゃ》). Bukan pekerjaan yang boleh dilakukan tanpa pengawasan.',
        cat: 'hourei',
      ...
      },
      {
        ...
        hint: 'Apa gejala awal heat stroke (熱中症《ねっちゅうしょう》)?',
        ...
        ans: 0,
        exp: 'Gejala awal heat stroke (熱中症《ねっちゅうしょう》): pusing (めまい), keringat berlebihan (大量《たいりょう》の汗《あせ》), kram otot (筋肉《きんにく》のけいれん). Kalau dibiarkan → pingsan → bisa meninggal.',
        cat: 'anzen',
      ...
      },
      {
        ...
        ans: 0,
        exp: 'Asuransi kecelakaan kerja (労災保険《ろうさいほけん》) berlaku untuk SEMUA pekerja termasuk pekerja asing (外国人《がいこくじん》). Ini hak kamu sebagai pekerja SSW.',
        cat: 'hourei',
      ...
      },
      {
        ...
        hint: 'Apa tujuan dari metode "pointing and calling" (指差し呼称《ゆびさしこしょう》)?',
        ...
        ans: 0,
        exp: '指差し呼称《ゆびさしこしょう》 (pointing and calling) = metode konfirmasi keselamatan dengan menunjuk + menyebut item yang dicek dengan suara keras. Terbukti mengurangi kesalahan hingga 85%.',
        cat: 'anzen',
      ...
      },
      {
        ...
        ans: 0,
        exp: '整理《せいり》・整頓《せいとん》 (5S — seiri, seiton) di proyek konstruksi = bukan soal estetika, tapi pencegahan kecelakaan (tersandung material) dan efisiensi (cepat cari alat).',
        cat: 'anzen',
      ...
      },
      {
        ...
        hint: 'Berapa tahun maksimum masa tinggal SSW 1号《いちごう》 di bidang konstruksi?',
        opts: ['通算《つうさん》5年《ねん》', '通算《つうさん》3年《ねん》', '通算《つうさん》10年《ねん》', '期限《きげん》なし'],
        opts_id: ['Total 5 tahun', 'Total 3 tahun', 'Total 10 tahun', 'Tanpa batas'],
        ans: 0,
        exp: 'SSW 1号《いちごう》 (特定技能《とくていぎのう》1号《いちごう》) di bidang konstruksi = masa tinggal maksimum total 5 tahun (通算《つうさん》5年《ごねん》). Setelah itu bisa upgrade ke SSW 2号《にごう》 yang tidak ada batas waktu.',
        cat: 'hourei',
