...
export const SET_KENCHIKU_01 = {
    ...
    questions: [
      ...
      },
      {
        ...
        hint: 'Apa fungsi selimut beton (かぶり厚《あつ》さ) pada tulangan?',
        ...
        ans: 0,
        exp: 'Concrete cover (かぶり厚《あつ》さ) = tebal selimut beton di atas tulangan. Fungsi utama: melindungi besi dari korosi (karat). Selimut tipis = besi cepat berkarat = bangunan runtuh.',
        cat: 'sekou',
      ...
      },
      {
        ...
        ans: 0,
        exp: 'Bekisting (型枠《かたわく》) harus akurat dimensinya dan cukup kuat menahan tekanan beton segar. Warna tidak relevan. Murah atau cepat tapi tidak akurat/kuat = beton bocor atau miring.',
        cat: 'sekou',
      ...
      },
      {
        ...
        ans: 0,
        exp: 'Vibrator beton digunakan untuk mengeluarkan gelembung udara (空気《くうき》) agar beton padat (密実《みつじつ》). Beton dengan banyak rongga udara = lemah. Vibrator bukan alat sinyal atau pengatur suhu.',
        cat: 'sekou',
      ...
      },
      {
        ...
        ans: 0,
        exp: 'Inspeksi scaffolding WAJIB setiap hari sebelum kerja dimulai (毎日《まいにち》の作業開始前《さぎょうかいしまえ》). Bukan bulanan atau tahunan. Setelah hujan/angin kencang juga harus inspeksi ulang.',
        cat: 'anzen',
      ...
      },
      {
        ...
        hint: 'Berapa panjang minimum sambungan tumpangan (重ね継手《かさねつぎて》) tulangan?',
        ...
        ans: 0,
        exp: 'Overlap joint (重ね継手《かさねつぎて》) = panjang tumpangan ≥40× diameter tulangan (contoh: D13 → tumpangan ≥520mm). 5× atau 2× terlalu pendek = sambungan tidak kuat.',
        cat: 'sekou',
      ...
      },
      {
        ...
        ans: 0,
        exp: '墨出し《すみだし》 = marking/layout — menandai posisi dinding, kolom, dan elemen struktur di permukaan lantai menggunakan tinta墨《すみ》 (sumi) dan 墨壺《すみつぼ》 (sumitsubo/chalk line).',
        cat: 'sekou',
      ...
      },
      {
        ...
        ans: 0,
        exp: 'Curing basah = menjaga kelembaban beton agar reaksi semen berlanjut optimal. Beton yang terlalu cepat kering = retak (乾燥収縮《かんそうしゅうしゅく》ひび割《わ》れ). Bukan untuk mendinginkan atau membersihkan.',
        cat: 'sekou',
      ...
      },
      {
        ...
        ans: 0,
        exp: '左官工事《さかんこうじ》 (plastering) = pekerjaan plester/acian menggunakan mortar atau plaster. Bukan pekerjaan listrik (電気《でんき》), pipa (水道《すいどう》), atau kaca (ガラス).',
        cat: 'sekou',
      ...
      },
      {
        ...
        ans: 0,
        exp: '根太《ねだ》 (ねだ) = floor joist/balok lantai horizontal yang menopang papan lantai. Bukan bagian dinding, atap, atau fondasi.',
        cat: 'sekou',
      ...
      },
      {
        ...
        ans: 0,
        exp: 'Waterproofing sheet: titik paling rawan bocor = sambungan antar sheet (接合部《せつごうぶ》). Harus di-overlap minimal sesuai spec dan direkatkan sempurna.',
        cat: 'sekou',
      ...
      },
      {
        ...
        hint: 'Apa yang termasuk dalam pekerjaan sementara (仮設工事《かせつこうじ》)?',
        ...
        ans: 0,
        exp: '仮設工事《かせつこうじ》 = pekerjaan sementara yang mendukung konstruksi: scaffolding (足場《あしば》), pagar proyek (仮囲い《かりかこい》), instalasi listrik sementara (仮設電気《かせつでんき》). Ini dibongkar setelah proyek selesai.',
        cat: 'sekou',
      ...
      },
      {
        ...
        hint: 'Apa fungsi material insulasi (断熱材《だんねつざい》)?',
        ...
        ans: 0,
        exp: '断熱材《だんねつざい》 = insulation material — menghalangi transfer panas antara luar dan dalam bangunan. Bukan dekorasi, bukan penghasil suara, dan bukan saluran air.',
        cat: 'sekou',
      ...
      },
      {
        ...
        hint: 'Apa yang dicek dalam inspeksi tulangan (配筋検査《はいきんけんさ》)?',
        ...
        ans: 0,
        exp: '配筋検査《はいきんけんさ》 = inspeksi tulangan sebelum cor — memastikan posisi (配置《はいち》), jarak (間隔《かんかく》), dan selimut beton (かぶり) sesuai gambar desain. Ini dilakukan SEBELUM beton dicor.',
        cat: 'sekou',
      ...
      },
      {
        ...
        hint: 'Apa yang diperiksa dalam proses izin bangunan (建築確認申請《けんちくかくにんしんせい》)?',
        ...
        ans: 0,
        exp: '建築確認申請《けんちくかくにんしんせい》 = permohonan izin bangunan — memeriksa apakah rencana konstruksi sesuai dengan peraturan bangunan (建築基準法《けんちくきじゅんほう》). Bukan soal harga, pekerja, atau cuaca.',
        cat: 'hourei',
