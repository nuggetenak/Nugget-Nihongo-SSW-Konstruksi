...
export const SET_JML05 = {
  ...
  questions: [
    ...
    },
    {
      ...
      opts: [
        '漏電《ろうでん》を瞬時《しゅんじ》に検知《けんち》・遮断《しゃだん》',
        '回転《かいてん》を止《と》める',
        '過電流《かでんりゅう》を止《と》める',
        '電圧《でんあつ》を下《さ》げる',
      ],
    ...
    },
    {
      ...
      opts: [
        '1年《ねん》使用《しよう》',
        '色褪《いろあ》せ',
        '落下衝撃後《らっかしょうげきご》または変形《へんけい》',
        '任意《にんい》',
      ],
      opts_id: ['Dipakai 1 tahun', 'Pudar warna', 'Setelah terkena jatuh atau deformasi', 'Bebas'],
      ans: 2,
    ...
    },
    {
      ...
      opts: [
        '強《つよ》い光（アーク光）と飛散物《ひさんぶつ》から目《め》を守《まも》る',
        '視力《しりょく》を上《あ》げる',
        '太陽光《たいようこう》を見《み》る',
        'ファッション',
      ],
    ...
    },
    {
      ...
      opts: [
        'ソケット',
        '管《かん》の端《はし》に付《つ》けるリング状《じょう》の継手《つぎて》',
        '分岐管《ぶんきかん》',
        '曲《ま》がり管《かん》',
      ],
    ...
    },
    {
      ...
      opts_id: ['Level', 'Protractor', 'Thickness gauge (caliper or dedicated)', 'Measuring tape'],
      ans: 2,
    ...
    },
    {
      ...
      opts: [
        '気密性《きみつせい》と防水性《ぼうすいせい》を確保《かくほ》',
        '厚《あつ》さを増《ふ》す',
        '見《み》た目《め》を良《よ》くする',
        '接着力《せっちゃくりょく》を下《さ》げる',
      ],
      opts_id: [
    ...
    },
    {
      ...
      opts: [
        '1年《ねん》に1回《かい》',
        '作業終了後《さぎょうしゅうりょうご》のみ',
        '点検不要《てんけんふよう》',
        '作業開始前《さぎょうかいしまえ》・悪天候後《あくてんこうご》・地震後《じしんご》',
      ],
      opts_id: [
        'Setahun sekali',
