// JAC Official — 学科 (Teori) Sets tt1+tt2 · 65qs · track:common (same for all 3 tracks)
export const JAC_TEORI = [
  {
    id: 'tt1_q01',
    set: 'tt1',
    setLabel: '学科 Set 1',
    ...
    options: [
      '興味を持たないこと（きょうみをもたないこと）(Tidak peduli)',
  ...
  },
  {
    ...
    options: [
      'パワー・ハラスメント (Power Harassment)',
      'セクシャル・ハラスメント (Sexual Harassment)',
      'アルコール・ハラスメント (Alcohol Harassment)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '安全が保証される（あんぜんがほしょうされる）(Yang menjamin keamanan)',
      '最低限の（さいていげんの）(Minimum)',
      '必要以上の（ひつよういじょうの）(Lebih dari yang diperlukan)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '増加（ぞうか）(Meningkatkan)',
      '軽減（けいげん）(Mengurangi / Meringankan)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '安価な水を供給する（あんかなみずをきょうきゅうする）(Menyuplai air yang terjangkau)',
      '高価な水を供給する（こうかなみずをきょうきゅうする）(Menyuplai air yang mahal)',
      '不浄な水を供給する（ふじょうなみずをきょうきゅうする）(Menyuplai air yang kotor)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      'ガス事業法（ガスじぎょうほう）(UU Usaha Gas)',
      '電気通信事業法（でんきつうしんじぎょうほう）(UU Usaha Telekomunikasi)',
      '電波法（でんぱほう）(UU Gelombang Radio)',
      '電気事業法（でんきじぎょうほう）(UU Usaha Kelistrikan)'
    ],
    answer: 3,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '住宅を作る工事（じゅうたくをつくるこうじ）(Membangun rumah)',
      '道路を作る工事（どうろをつくるこうじ）(Membangun jalan)',
      'ダムを作る工事（ダムをつくるこうじ）(Membangun bendungan)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '防水装置（ぼうすいそうち）(Alat kedap air)',
      '免振装置（めんしんそうち）(Alat isolasi seismik)',
      '空調装置（くうちょうそうち）(Alat AC)'
    ],
    answer: 1,
    hasPhoto: true,
  ...
  },
  {
    ...
    options: [
      'ライフライン工事（ライフラインこうじ）(Pekerjaan lifeline)',
      '建築工事（けんちくこうじ）(Pekerjaan bangunan)',
      '土木工事（どぼくこうじ）(Pekerjaan sipil)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '掘削工事（くっさくこうじ）(Pekerjaan penggalian)',
      'トンネル工事（トンネルこうじ）(Pekerjaan terowongan)',
      'さく井工事（さくいこうじ）(Pekerjaan pengeboran sumur)',
      '穴掘工事（あなほりこうじ）(Pekerjaan gali lubang)'
    ],
    answer: 2,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '工場で製作した杭を、現場に運んで打ち込む工法（こうじょうでせいさくしたくいを、げんばにはこんでうちこむこうほう）(Tiang dibuat di pabrik, dibawa & dipancang di lapangan)',
      '工事現場で杭を作る工法（こうじげんばでくいをつくるこうほう）(Tiang dibuat di lokasi proyek)',
      '既に使用された杭を再利用する工法（すでにしようされたくいをさいりようするこうほう）(Tiang bekas digunakan kembali)',
      '穴の中に生コンクリートを入れて杭を造る工法（あなのなかになまコンクリートをいれてくいをつくるこうほう）(Beton segar dituang ke lubang untuk membuat tiang)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '鉄筋工事（てっきんこうじ）(Pekerjaan pembesian)',
      '型枠工事（かたわくこうじ）(Pekerjaan bekisting)',
      '鉄筋継手工事（てっきんつぎてこうじ）(Pekerjaan sambungan tulangan)',
      '鉄骨工事（てっこつこうじ）(Pekerjaan struktur baja)'
    ],
    answer: 3,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '鉄筋工事（てっきんこうじ）(Pembesian)',
      '鉄筋継手工事（てっきんつぎてこうじ）(Sambungan tulangan)',
      '型枠工事（かたわくこうじ）(Bekisting/formwork)',
      '窓枠工事（まどわくこうじ）(Pemasangan kusen jendela)'
    ],
    answer: 2,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      'コンクリート打設工事（コンクリートだせつこうじ）(Pengecoran beton)',
      '機械土工事（きかいどこうじ）(Pekerjaan tanah mekanis)',
      'サッシ工事（サッシこうじ）(Pemasangan kusen aluminium)',
      '屋根工事（やねこうじ）(Pekerjaan atap)'
    ],
    answer: 0,
    hasPhoto: true,
  ...
  },
  {
    ...
    options: [
      '電気工事士（でんきこうじし）(Teknisi pekerjaan listrik)',
      '工事担任者（こうじたんにんしゃ）(Penanggung jawab pekerjaan telekomunikasi)',
      '電気通信主任技術者（でんきつうしんしゅにんぎじゅつしゃ）(Insinyur kepala telekomunikasi)',
      '消防設備士（しょうぼうせつびし）(Teknisi peralatan pemadam)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '洗面器（せんめんき）(Wastafel)',
      '焼却炉（しょうきゃくろ）(Incinerator/tungku pembakaran)',
      'スプリンクラー (Sprinkler)',
      'エアコン (AC)'
    ],
    answer: 2,
  ...
  },
  {
    ...
    options: [
      ...
      '直す（なおす）(Memperbaiki)',
      '組み立てる（くみたてる）(Merakit)',
      '壊す（こわす）(Menghancurkan/membongkar)'
    ],
    answer: 3,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '免許（めんきょ）(Lisensi/izin resmi)',
      'パスポート (Paspor)',
      '在留カード（ざいりゅうカード）(Kartu izin tinggal)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '海外（かいがい）(Di luar negeri)',
      '社内（しゃない）(Di dalam perusahaan)',
      '労働局（ろうどうきょく）(Di kantor tenaga kerja)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      'お大事に（おだいじに）(Jaga kesehatan ya)',
      'ご安全（あんぜん）に (Semoga selamat)',
      'ご注意（ちゅうい）を (Harap berhati-hati)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      ...
      'どういたしまして (Sama-sama)',
      'おつかれさまです (Terima kasih atas kerja kerasnya)'
    ],
    answer: 2,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '立て墨（たてずみ）(Garis vertikal)',
      '逃げ墨（にげずみ）(Garis referensi offset)',
      '仕上げ墨（しあげずみ）(Garis finishing)',
      '地墨（じずみ）(Garis lantai)'
    ],
    answer: 3,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '根切り（ねぎり）(Penggalian fondasi)',
      '盛り土（もりど）(Urugan/timbunan tanah)',
      '埋戻し（うめもどし）(Pengurugan kembali)',
      '素掘り（すぼり）(Galian mentah tanpa perkuatan)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      'あき (Jarak bebas antar tulangan)',
      'あそび (Kelonggaran)',
      'かぶり厚さ（かぶりあつさ）(Selimut beton / concrete cover)',
      '間隔（かんかく）(Jarak/spasi)'
    ],
    answer: 2,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '空調（くうちょう）(AC / pengkondisian udara)',
      '換気（かんき）(Ventilasi)',
      '排煙（はいえん）(Pembuangan asap)',
      '衛生（えいせい）(Sanitasi)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '喫煙は、まわりから見えない場所で隠れてする（きつえんは、まわりからみえないばしょでかくれてする）(Merokok di tempat tersembunyi dari pandangan orang)',
      'ごみが落（お）ちているのを見（み）つけたら、そのままにしておく (Biarkan sampah yang ditemukan)',
      'ヘルメットや安全帯は決められた場所に置く（ヘルメットやあんぜんたいはきめられたばしょにおく）(Simpan helm & harness di tempat yang ditentukan)'
    ],
    answer: 2,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '朝礼（ちょうれい）(Apel pagi)',
      'ラジオ体操（ラジオたいそう）(Senam radio)',
      '安全唱和（あんぜんしょうわ）(Nyanyian keselamatan)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      'KY活動（KYかつどう）(Kegiatan KY/identifikasi bahaya)',
      'タッチアンドコール (Touch-and-call)',
      'ラジオ体操（ラジオたいそう）(Senam radio)'
    ],
    answer: 1,
    hasPhoto: true,
  ...
  },
  {
    ...
    options: [
      '事業主（じぎょうぬし）(Pengusaha/pemberi kerja)',
      '労働者（ろうどうしゃ）(Pekerja/karyawan)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '雇用保険法（こようほけんほう）(UU Asuransi Ketenagakerjaan)',
      '労働安全衛生法（ろうどうあんぜんえいせいほう）(UU Keselamatan & Kesehatan Kerja)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '建設業を営む者の資質の向上（けんせつぎょうをいとなむもののししつのこうじょう）(Peningkatan KUALITAS SDM pelaku konstruksi)',
      '建設業を営む者の技能の向上（けんせつぎょうをいとなむもののぎのうのこうじょう）(Peningkatan KETERAMPILAN pelaku konstruksi)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '大気汚染物質（たいきおせんぶっしつ）(Polutan udara)',
      '廃材（はいざい）(Material sisa/limbah konstruksi)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '火災や感電（かさいやかんでん）(Kebakaran dan sengatan listrik)',
      'ガス漏れ（ガスもれ）(Kebocoran gas)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '治水（ちすい）(Pengendalian banjir)',
      '汚水（おすい）(Air kotor/limbah)',
      '排水（はいすい）(Drainase/pembuangan air)',
      '治山（ちざん）(Konservasi lahan pegunungan)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '仮設（かせつ）(Instalasi sementara)',
      '排水（はいすい）(Drainase)',
      '山留め（やまどめ）(Penahan tanah galian)',
      '試掘（しくつ）(Galian uji coba)'
    ],
    answer: 2,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '内装仕上げ（ないそうしあげ）(Finishing interior)',
      '建具（たてぐ）(Kusen pintu/jendela)',
      '屋根（やね）(Atap)',
      '躯体（くたい）(Struktur utama/kutai)'
    ],
    answer: 3,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      'ケーブル工事（ケーブルこうじ）(Pekerjaan kabel)',
      '管路の工事（かんろのこうじ）(Pekerjaan jalur pipa)',
      '配電盤の工事（はいでんばんのこうじ）(Pekerjaan panel distribusi listrik)',
      '電柱工事（でんちゅうこうじ）(Pekerjaan tiang listrik)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '電気通信工事（でんきつうしんこうじ）(Pekerjaan telekomunikasi)',
      '上水道工事（じょうすいどうこうじ）(Pekerjaan air bersih)',
      '下水道工事（げすいどうこうじ）(Pekerjaan saluran air limbah)',
      '電気工事（でんきこうじ）(Pekerjaan listrik)'
    ],
    answer: 2,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      'ジャッキ (Dongkrak hidrolik/jack)',
      'クレーン (Crane)',
      '押輪（おしわ）(Cincin pendorong)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      'マネジメント講習（マネジメントこうしゅう）(Pelatihan manajemen)',
      '技能講習（ぎのうこうしゅう）(Pelatihan keterampilan)',
      '基幹技能者講習（きかんぎのうしゃこうしゅう）(Pelatihan teknisi inti)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '積み込み作業（つみこみさぎょう）(Pekerjaan pemuatan/loading)',
      '盛り土作業（もりどさぎょう）(Pekerjaan urugan tanah)',
      '敷き均し作業（しきならしさぎょう）(Pekerjaan penghamparan/grading)'
    ],
    answer: 2,
    hasPhoto: true,
  ...
  },
  {
    ...
    options: [
      '押土（おしど）(Mendorong tanah)',
      '運搬（うんぱん）(Pengangkutan)',
      '掘削（くっさく）(Penggalian)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      'カーテン工事（カーテンこうじ）(Pemasangan tirai/curtain)',
      '漆喰補修工事（しっくいほしゅうこうじ）(Perbaikan plester mortar)',
      '吹付けウレタン断熱工事（ふきつけウレタンだんねつこうじ）(Semprot insulasi uretan)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '打設（だせつ）(Pengecoran)',
      '保温（ほおん）(Isolasi termal)',
      '支保工（しほこう）(Perancah penyangga/shoring)'
    ],
    answer: 2,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '機械式継手（きかいしきつぎて）(Sambungan mekanis/coupler)',
      '重ね継手（かさねつぎて）(Sambungan tumpang)',
      '溶接継手（ようせつつぎて）(Sambungan las)'
    ],
    answer: 0,
    hasPhoto: true,
  ...
  },
  {
    ...
    options: [
      '溶接継手（ようせつつぎて）(Las listrik)',
      'ガス圧接継手（ガスあっせつつぎて）(Gas pressure welding)',
      '重ね継手（かさねつぎて）(Tumpang)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '配線工事（はいせんこうじ）(Pekerjaan pengkabelan)',
      '接地工事（せっちこうじ）(Pekerjaan pentanahan)',
      '内線工事（ないせんこうじ）(Pekerjaan instalasi dalam gedung)'
    ],
    answer: 2,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '無線方式（むせんほうしき）(Sistem nirkabel)',
      '光ファイバー（ひかりファイバー）(Serat optik)',
      'インターネット (Internet)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      'エアコン (AC)',
      'トイレの便器（トイレのべんき）(Closet/toilet)',
      '貯湯槽（ちょとうそう）(Tangki air panas)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '消火設備（しょうかせつび）(Peralatan pemadam kebakaran)',
      '避難設備（ひなんせつび）(Peralatan evakuasi)',
      '警報設備（けいほうせつび）(Peralatan alarm/peringatan)'
    ],
    answer: 2,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '危ない（あぶない）(Bahaya! / Awas!)',
      '足元よし（あしもとよし）(Kondisi kaki/pijakan aman)',
      'ご安全（あんぜん）に (Semoga selamat)',
      '起立（きりつ）(Berdiri)'
    ],
    answer: 0,
  ...
  },
  {
    ...
    options: [
      '水盛り（みずもり）(Penyamaan ketinggian dengan air)',
      '遣り方（やりかた）(Setting-out/tata letak referensi)',
      '水貫（みずぬき）(Papan horizontal referensi)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '路床（ろしょう）(Subgrade/lapisan sub-dasar jalan)',
      '締固め（しめかため）(Pemadatan)',
      '段切り（だんぎり）(Potongan bertangga/step cutting)'
    ],
    answer: 2,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '坪（つぼ）(Tsubo — satuan luas tradisional)',
      '寸（すん）(Sun — satuan panjang)',
      '尺（しゃく）(Shaku — satuan panjang)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '打ち込み（うちこみ）(Pemakuan/menancapkan paku)',
      '釘仕舞（くぎじまい）(Mencabut dan menyimpan paku)',
      '釘止め（くぎどめ）(Pengikatan dengan paku)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '接地（せっち）(Pentanahan/grounding)',
      '漏電（ろうでん）(Kebocoran arus)',
      '通線（つうせん）(Penarikan kabel)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '掃除（そうじ）(Membersihkan)',
      '整頓（せいとん）(Menata/merapikan — Seiton)',
      '清潔（せいけつ）(Bersih/higienis — Seiketsu)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '上着のボタンは外したままにする（うわぎのボタンははずしたままにする）(Biarkan kancing jaket terbuka)',
      '暑い時は半袖を着用する（あついときははんそでをちゃくようする）(Saat panas, pakai baju lengan pendek)',
      '袖は手首までおろして着用する（そではてくびまでおろしてちゃくようする）(Turunkan lengan baju hingga pergelangan tangan)'
    ],
    answer: 2,
    hasPhoto: false,
