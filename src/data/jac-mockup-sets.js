...
export const JAC_MOCKUP_SETS = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 9,
        q: '銅管《どうかん》の「キャピラリー継手《つぎて》」で、ろう材《ざい》がすきまに入《はい》る仕組み《しくみ》は？',
        hint: 'Mekanisme masuknya bahan brazing ke celah capillary fitting pipa tembaga adalah?',
        opts: [
          '毛細管現象《もうさいかんげんしょう》ですきまに吸《す》い込《こ》まれる',
          '重力《じゅうりょく》で上《うえ》から下《した》へ流《なが》れ落《お》ちる',
          'ポンプで圧力《あつりょく》をかけて無理《むり》に押《お》し込《こ》む',
          '母材《ぼざい》の銅《どう》が溶《と》けて混《ま》ざり合《あ》う',
        ],
        opts_id: [
          'Tersedot sendiri ke celah oleh gaya kapiler',
          'Mengalir turun dari atas ke bawah karena gravitasi',
          'Didorong masuk paksa dengan tekanan dari pompa',
          'Tembaga pipanya ikut meleleh lalu menyatu',
        ],
        ans: 0,
        exp: 'キャピラリー継手 dinamai dari gaya kapiler: bahan brazing yang meleleh tersedot sendiri ke celah sempit antara pipa dan socket, tanpa perlu didorong. Pipa tembaganya sendiri tidak meleleh — itu bedanya ろう接 (brazing) dengan 融接 (pengelasan).',
        related_card_id: 451,
      },
      {
        id: 10,
