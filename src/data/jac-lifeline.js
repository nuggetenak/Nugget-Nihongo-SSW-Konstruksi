...
export const JAC_LIFELINE = [
  ...
  },
  {
    ...
    options: [
      'ドライバー (Obeng)',
      'ポンチ (Punch/penanda)',
      'ファイバカッター (Pemotong serat)',
      '電工ナイフ（でんこうナイフ）(Pisau listrik)'
    ],
    answer: 3,
    hasPhoto: true,
  ...
  },
  {
    ...
    id_text: 'Apa nama alat dalam foto?',
    options: [
      'パイプ万力（パイプまんりき）(Ragum pipa)',
      'パイプカッター (Pemotong pipa)',
      'パイプねじ切機（パイプねじきりき）(Mesin ulir pipa)',
      'パイプレンチ (Kunci pipa)'
    ],
    answer: 1,
    hasPhoto: true,
  ...
  },
  {
    ...
    options: [
      '消火器（しょうかき）(APAR)',
      '屋内消火栓設備（おくないしょうかせんせつび）(Hidran dalam gedung)',
      'スプリンクラー設備（スプリンクラーせつび）(Sprinkler)',
      '屋外消火栓設備（おくがいしょうかせんせつび）(Hidran luar gedung)'
    ],
    answer: 3,
    hasPhoto: true,
  ...
  },
  {
    ...
    options: [
      '墨さし（すみさし）(Kuas tinta)',
      'チョーク (Kapur)',
      '墨つぼ（すみつぼ）(Wadah tinta/chalk line reel)',
      'レーザー墨出し器（レーザーすみだしき）(Laser marker)'
    ],
    answer: 2,
    hasPhoto: true,
  ...
  },
  {
    ...
    options: [
      '三脚（さんきゃく）(Tripod)',
      '気泡管（きほうかん）(Tabung gelembung)',
      '望遠鏡（ぼうえんきょう）(Teleskop)',
      'レベル (Level/waterpas survei)'
    ],
    answer: 3,
    hasPhoto: true,
  ...
  },
  {
    ...
    options: [
      '100A以上（100Aいじょう）(100A ke atas)',
      '15A～100A',
      '15A以下（15Aいか）(15A ke bawah)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '通信ケーブル（つうしんケーブル）(Kabel komunikasi)',
      '管路（かんろ）(Jalur kabel bawah tanah)',
      '電柱（でんちゅう）(Tiang listrik/telepon)',
      'マンホール (Manhole)'
    ],
    answer: 2,
    hasPhoto: true,
  ...
  },
  {
    ...
    options: [
      '保温材（ほおんざい）(Bahan isolasi panas)',
      '保冷材（ほれいざい）(Bahan isolasi dingin)',
      '耐火物（たいかぶつ）(Bahan tahan api)',
      '断熱材（だんねつざい）(Bahan insulasi)'
    ],
    answer: 2,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '墜落・転落（ついらく・てんらく）(Jatuh dari ketinggian / bergulir)',
      '建設機械・クレーンなど災害（けんせつきかい・クレーンなどさいがい）(Kecelakaan mesin/crane)',
      '高温・低温の物との接触（こうおん・ていおんのものとのせっしょく）(Kontak benda suhu ekstrem)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      'マンホール内での作業（マンホールないでのさぎょう）(Di dalam manhole)',
      '電柱の上での作業（でんちゅうのうえでのさぎょう）(Di atas tiang listrik)',
      '建物屋上での作業（たてものおくじょうでのさぎょう）(Di atap gedung)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '損失が小さい（そんしつがちいさい）(Rugi-rugi kecil)',
      '重い（おもい）(Berat)',
      '傷に強い（きずにつよい）(Tahan goresan)',
      '伝送容量が小さい（でんそうようりょうがちいさい）(Kapasitas transmisi kecil)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      'ファイバーカッター (Pemotong serat)',
      'OTDR',
      '光パワーメーター（ひかりパワーメーター）(Pengukur daya optik)',
      'クランプメーター (Clamp meter)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      'コネクタ接続（コネクタせつぞく）(Sambungan konektor)',
      'はんだあげ (Soldering)',
      '融着接続（ゆうちゃくせつぞく）(Fusion splicing)',
      'メカニカルスプライス接続（メカニカルスプライスせつぞく）(Mechanical splice)'
    ],
    answer: 2,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '除湿器（じょしつき）(Penyerap kelembapan)',
      '冷却コイル（れいきゃくコイル）(Koil pendingin)',
      'けい酸カルシウム保温材（けいさんカルシウムほおんざい）(Isolasi kalsium silikat)',
      '加湿器（かしつき）(Pelembap udara)'
    ],
    answer: 3,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      'グラスウール保温材（グラスウールほおんざい）(Wol kaca)',
      'ロックウール保温材（ロックウールほおんざい）(Wol batu)',
      'ポリスチレンフォーム保温材（ポリスチレンフォームほおんざい）(Busa polistiren)',
      'けい酸カルシウム保温材（けいさんカルシウムほおんざい）(Kalsium silikat)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    id_text: 'Apa nama alat dalam foto?',
    options: [
      '一輪車（いちりんしゃ）(Gerobak satu roda)',
      '台車（だいしゃ）(Kereta dorong datar)',
      'そり (Sledge)',
      'ころ (Roller)'
    ],
    answer: 1,
  ...
  },
  {
    ...
    options: [
      'ラッキングカバー (Lagging cover)',
      'マグパイプカバー (Mag pipe cover)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      'ねじ接合（ねじせつごう）(Sambungan ulir)',
      'ＥＦ接合（ＥＦせつごう）(EF / Electro Fusion)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '差し込み継手工法（さしこみつぎてこうほう）(Insert joint method)',
      '共板フランジ工法（きょうばんフランジこうほう）(Common plate flange method)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '穴掘建柱車（あなほりけんちゅうしゃ）(Kendaraan penggali & pendiri tiang)',
      '手掘り（てぼり）(Penggalian manual)'
    ],
    answer: 1,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '管路（かんろ）(Jalur kabel bawah tanah)',
      '共同溝（きょうどうこう）(Terowongan utilitas bersama)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '耐熱断熱煉瓦用モルタル（たいねつだんねつれんがようモルタル）(Mortar khusus bata tahan api)',
      '樹脂モルタル（じゅしモルタル）(Mortar resin)'
    ],
    answer: 0,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '新規入場者教育（しんきにゅうじょうしゃきょういく）(Pendidikan pekerja baru lokasi kerja)',
      '安全パトロール（あんぜんパトロール）(Patroli keselamatan)',
      '新入者安全衛生教育（しんにゅうしゃあんぜんえいせいきょういく）(Pendidikan K3 pekerja baru perusahaan)'
    ],
    answer: 2,
    hasPhoto: false,
  ...
  },
  {
    ...
    options: [
      '適切な睡眠と食事をとること（てきせつなすいみんとしょくじをとること）(Tidur & makan yang cukup)',
      'お酒を飲んで作業すること（おさけをのんでさぎょうすること）(Bekerja sambil minum alkohol)',
      '前日に徹夜すること（ぜんじつにてつやすること）(Begadang sehari sebelumnya)'
    ],
    answer: 0,
    hasPhoto: false,
